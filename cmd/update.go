...
const repoURL = "https://github.com/the20100/typeform-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update typeform to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "typeform-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "typeform")
